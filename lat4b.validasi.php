    ...
    <form action="#" method="post" enctype="multipart/form-data">
      ...
      <table border="1" align="center" celpadding="5" cellspacing="1">
        ...
        <tr>
          ...
          <td><input type="text" name="nrp" placeholder="isikan nrp.." />
        ...
        <tr>
            ...
            <td> <input type="text" name="lahir" size="44"><br><span style='color:red'><?= $errorlahir??'' ?></span></td>
        </tr>
        <tr>
            <td><label for="">Tanggal Lahir</label></td>
            <td><input type="date" name="tgl"><br><span style='color:red'><?= $errortgl??'' ?></span></td>
        </tr>
        <tr>
